                        ...
                        {task.completed ? (
                            ...
                            <>
                                <i className="icon svgIcon checkbox-20">
                                    <svg focusable="false" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 20c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8m0-17c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9"></path></svg>
                                </i>
                                <i className="icon svgIcon checkbox-completed-outline-20 checkBox-hover">
                                    <svg focusable="false" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fillRule="evenodd"><path d="M12 20c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8m0-17c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9"></path><path d="M10.9902 13.3027l-2.487-2.51-.71.704 3.193 3.224 5.221-5.221-.707-.707z"></path></g></svg>
                                </i>
                            </>
                        )}
                    </span>
                                    ...
                                    {task.myDay && (
                                        <span className='metaDataInfo-group'>
                                            <span className='taskItemInfo-myDay'>
                                                <i className="icon svgIcon my-day-16"><svg focusable="false" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="16" height="16" viewBox="0 0 16 16"><defs><path id="a" d="M0 10h10V0H0z"></path></defs><g fillRule="evenodd" transform="translate(3 3)"><path d="M5 3.5c-.827 0-1.5.673-1.5 1.5S4.173 6.5 5 6.5 6.5 5.827 6.5 5 5.827 3.5 5 3.5"></path><path d="M4.5 2h1V0h-1zm0 8h1V8h-1zM8 5.5h2v-1H8zm-8 0h2v-1H0zm8.8892-3.6821l-.707-.707-1.414 1.414.707.707zM1.1108 8.1821l.707.707 1.414-1.414-.707-.707zm5.6573-.707l1.414 1.414.707-.707-1.414-1.414zM1.1108 1.8179l1.414 1.414.707-.707-1.414-1.414z" mask="url(https://to-do.microsoft.com/tasks/id/AQMkADAwATNiZmYAZC0yMzc3AC05ZDY4LTAwAi0wMAoARgAAA0oYxRx2yAZFr2dNRTrf-jsHAJc3Tf-qvQlIi8bDlmS5iO0AAAAChDFuAAAAlzdN-_q9CUiLxsOWZLmI7QAAAAKERQsAAAA=/details#b)"></path></g></svg></i>
                                        ...
                                        <span className='metaDataInfo-group'>
                                            {(!task.completed && task.reminder && Date.now() < new Date(task.reminder.date).getTime()) && (
                                                <span className="taskItemInfo-reminder" title="今天">
                                                    <i className="icon svgIcon reminder-16"><svg focusable="false" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fillRule="evenodd" d="M5 10V7c0-1.654 1.346-3 3-3s3 1.346 3 3v3H5zm2 1h2c0 .551-.449 1-1 1-.551 0-1-.449-1-1zm5-1V7c0-2.206-1.794-4-4-4S4 4.794 4 7v3H3v1h3c0 1.103.897 2 2 2s2-.897 2-2h3v-1h-1z"></path></svg></i>
                                                </span>
                                            )}
                                            {task.note && (
                                                <span className="taskItemInfo-note">
                                                    <i className="icon svgIcon note-16"><svg focusable="false" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fillRule="evenodd" d="M3 3v10h5.957L13 8.957V3H3zm1 1h8v3.999H8V12H4V4zm5 5h2.543L9 11.543V9z" fill='#767678'></path></svg></i>
                                                </span>
                                            )}
                                        </span>
                                    )}
                        ...
                        <div className='headerLeftRegion-Region_1'>
                            ...
                            <div className='searchBox-container'>
                                <div className={`searchToolbar ${searchVisible ? 'search-is-open search-is-active' : ''}`}>
                                    <span className='searchToolbar-iconWrapper' onClick={() => this.setState({ searchVisible: true })}>
                ...
                <div className={`app ${selected_list.theme ? 'theme-' + selected_list.theme : ''}`}>
                    ...
                    <div className='main'>
                        ...
                        <div className='flex-container'>
                            {reminderList.map(t => <Notification key={t._id} reminderList={reminderList} setReminderList={this.setReminderList} task={t} />)}
                                ...
                                {selected_list.sort_type > 0 && (
                                    <div className="sortingIndicator shrinkSort-enter-done">
                                        <div className="sortingIndicator-inner">
                                            ...
                                            <button className="sortingIndicator-disable" onClick={() => listAction.changeListSortType(selected_list, 0)}>
                    ...
                    </div>
                    {
                        selected_task && (
                            <div
                                className={`rightColumn ${selected_task ? 'rightColumn-entered' : 'rightColumn-exited'}`}
                            >
                                <div className='details'>
                                    <div className='details-body'>
                                        <div className={`detailHeader ${selected_task.completed ? 'completed' : ''}`}>
                                            <div className='detailHeader-titleWrapper'>
                                                ...
                                                <span className='importanceButton' onClick={() => taskAction.changeTaskImportance(selected_task)}>
                                        ...
                                        <div className='section'>
                                            <ContextMenuTrigger id='taskSchedule-remind' holdToDisplay={0}>
                                                <div className={`section-item ${selected_task.reminder ? 'isSet' : ''} ${selected_task.reminder ? ((new Date(selected_task.reminder.date).getTime() < Date.now() || selected_task.completed) ? 'isInactive' : '') : ''}`}>
                                                    <button className='section-innerClick'>
                                                        <div className='section-inner'>
                                                            <div className='section-icon'>
                                                                <svg viewBox="64 64 896 896" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="48103" width="1rem" height="1rem"><path d="M512 813.248c-158.784 0-288-129.216-288-288s129.216-288 288-288 288 129.216 288 288-129.216 288-288 288m0-640c-194.08 0-352 157.92-352 352 0 101.856 43.744 193.472 113.152 257.824a31.04 31.04 0 0 0-13.248 7.552l-58.528 58.56a31.968 31.968 0 1 0 45.248 45.216l58.528-58.528a31.584 31.584 0 0 0 8.832-19.84A349.664 349.664 0 0 0 512 877.248c71.328 0 137.664-21.44 193.152-58.048a31.04 31.04 0 0 0 8.224 16.672l58.528 58.56a31.904 31.904 0 0 0 45.248 0 32 32 0 0 0 0-45.28l-58.528-58.528a31.36 31.36 0 0 0-9.28-6.176C819.616 720.064 864 627.84 864 525.248c0-194.08-157.92-352-352-352" p-id="48104" fill={selected_task.reminder ? ((new Date(selected_task.reminder.date).getTime() < Date.now() || selected_task.completed) ? '#767678' : '#465efc') : '#767678'}></path><path d="M544 519.104v-185.856a32 32 0 0 0-64 0v199.104c0 8.48 3.36 16.64 9.376 22.624l107.296 107.296a31.904 31.904 0 0 0 45.248 0 32 32 0 0 0 0-45.248L544 519.104zM182.624 286.4l90.528-90.56a32 32 0 0 0-45.248-45.216L137.376 241.152A31.968 31.968 0 1 0 182.624 286.4M883.872 227.872l-90.496-90.496a31.968 31.968 0 1 0-45.248 45.248l90.496 90.496a31.904 31.904 0 0 0 45.248 0 31.968 31.968 0 0 0 0-45.248" p-id="48105" fill={selected_task.reminder ? ((new Date(selected_task.reminder.date).getTime() < Date.now() || selected_task.completed) ? '#767678' : '#465efc') : '#767678'}></path></svg>
                                                            </div>
                                                            <div className='section-content'>
                                                                ...
                                                                {selected_task.reminder && <div className='section-description'>{`${formatDate(selected_task.reminder.date, 'Year')}`}</div>}
                                                            </div>
                                                        </div>
                                                    </button>
                                            ...
                                            <ContextMenuTrigger id='taskSchedule-deadline' holdToDisplay={0}>
                                                <div className={`section-item ${selected_task.due_date ? 'isSet' : ''} ${selected_task.due_date ? (selected_task.completed ? 'isInactive' : (new Date(selected_task.due_date).getTime() < new Date().setHours(0, 0, 0, 0) ? 'isPast' : '')) : ''}`}>
                                                    <button className='section-innerClick'>
                                                        <div className='section-inner'>
                                                            <div className='section-icon'>
                                                                <svg viewBox="64 64 896 896" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8197" width="1em" height="1em"><path d="M288 128v32H160v704h704V160h-128V128h-64v32H352V128zM224 224h64v32h64V224h320v32h64V224h64v64H224z m0 128h576v448H224z m192 64v64h64v-64z m128 0v64h64v-64z m128 0v64h64v-64zM288 544v64h64v-64z m128 0v64h64v-64z m128 0v64h64v-64z m128 0v64h64v-64zM288 672v64h64v-64z m128 0v64h64v-64z m128 0v64h64v-64z" p-id="8198"></path></svg>
                                                            </div>
                                                            <div className='section-content'>
                                                                <div className='section-title'>
                                                                    {
                                                    ...
                                                    <button className="section-delete" title="删除截止日期" onClick={() => taskAction.setTaskDueDate(selected_task)}>
                                                        <svg viewBox="64 64 896 896" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2170" width=".6rem" height=".6rem"><path d="M877.216 491.808M575.328 510.496 946.784 140.672c17.568-17.504 17.664-45.824 0.192-63.424-17.504-17.632-45.792-17.664-63.36-0.192L512.032 446.944 143.712 77.216C126.304 59.712 97.92 59.648 80.384 77.12 62.848 94.624 62.816 123.008 80.288 140.576l368.224 369.632L77.216 879.808c-17.568 17.504-17.664 45.824-0.192 63.424 8.736 8.8 20.256 13.216 31.776 13.216 11.424 0 22.848-4.352 31.584-13.056l371.36-369.696 371.68 373.088C892.192 955.616 903.68 960 915.168 960c11.456 0 22.912-4.384 31.648-13.088 17.504-17.504 17.568-45.824 0.096-63.392L575.328 510.496 575.328 510.496zM575.328 510.496" p-id="2171" fill="#767678"></path></svg>
                                                    </button>
                                                </div>
                                            </ContextMenuTrigger>
                                        ...
                                        <div className='section no-border'>
                                            ...
                                            >
                                                <div className={`editableContent ${noteInputVisible ? 'edit' : ''} ${selected_task.note ? '' : 'empty'} multiLine`}>
                                                    {
                                                        noteInputVisible ? (
                                                            <div
                                    ...
                                    <div className='detailFooter'>
                                        <button className='detailFooter-close' onClick={() => this.props.history.push(`/lists/${list_index}`)}>
                                            <svg viewBox="64 64 896 896" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="59355" width="1rem" height="1rem"><path d="M567.957453 787.362488l0-95.78453c0-17.632589-14.294564-31.927153-31.927153-31.927153s-31.927153 14.294564-31.927153 31.927153l0 64.111157c0 17.49035-14.178931 31.66928-31.66928 31.66928l-255.92888 0c-17.49035 0-31.66928-14.178931-31.66928-31.66928L184.835705 244.346077c0-17.49035 14.178931-31.66928 31.66928-31.66928l255.92888 0c17.49035 0 31.66928 14.178931 31.66928 31.66928l0 64.0999 0 0 0 0.011256c0 17.632589 14.294564 31.927153 31.927153 31.927153s31.927153-14.294564 31.927153-31.927153l0-0.011256 0 0 0-95.773274c0-35.263132-28.586059-63.84919-63.84919-63.84919L184.832635 148.823514c-35.263132 0-63.84919 28.586059-63.84919 63.84919L120.983445 787.362488c0 35.263132 28.586059 63.84919 63.84919 63.84919l319.275627 0C539.371394 851.212702 567.957453 822.62562 567.957453 787.362488z" p-id="59356" fill="#767678"></path><path d="M704.94029 286.170648c-12.367679 12.367679-12.367679 32.419364 0 44.787042l137.133264 137.133264L344.212576 468.090954c-17.49035 0-31.66928 14.178931-31.66928 31.66928l0 0.514723c0 17.49035 14.178931 31.66928 31.66928 31.66928l497.860978 0-137.133264 137.133264c-12.367679 12.367679-12.367679 32.419364 0 44.787042l0.364297 0.364297c12.367679 12.367679 32.419364 12.367679 44.787042 0L939.958932 524.361539c6.801916-5.808286 11.119245-14.440897 11.119245-24.086581l0-0.148379 0-0.005117 0-0.207731 0-0.005117 0-0.148379c0-9.645684-4.317329-18.277272-11.119245-24.086581L750.09163 285.806351c-12.367679-12.367679-32.419364-12.367679-44.787042 0L704.94029 286.170648z" p-id="59357" fill="#767678"></path></svg>
                                        </button>
