            ...
            <div id="notifications">
                <div className="notificationToast toast-transition-enter-done">
                                ...
                                <span className="metaDataInfo-group"> 
                                    <span className="taskItemInfo-reminder" title="明天">
                                        <i className="icon svgIcon reminder-16">
                                            <svg focusable="false" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fillRule="evenodd" d="M5 10V7c0-1.654 1.346-3 3-3s3 1.346 3 3v3H5zm2 1h2c0 .551-.449 1-1 1-.551 0-1-.449-1-1zm5-1V7c0-2.206-1.794-4-4-4S4 4.794 4 7v3H3v1h3c0 1.103.897 2 2 2s2-.897 2-2h3v-1h-1z"></path></svg>
                                        </i>
                                    </span> 
                                </span>
                            </div>
                    ...
                    <div className="notificationToast-buttons">
                        ...
                        <button className="notificationToast-cancelButton" onClick={this.finish}><span>解除</span></button>
                    </div>
                </div>
            </div>
        )
